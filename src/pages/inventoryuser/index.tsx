...
const appletDesc = `This applet guides the user through updating their Mac's invetory with an Okta username by:

- Prompting the user for their Okta Username
- Providing the username to MBT for use in a script
- Showing a 'working' screen
- Letting the user know their account has been updated
`;
