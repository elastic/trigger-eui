    ...
    body={
      <Fragment>
        <EuiText>
          ...
          <p>
            Thank You for taking the time to update. Doing so helps keep you
            (and Elastic) safe, secure, and bug free.{' '}
            <EuiIcon type="heart" size="m" />
          </p>
          <p>
            If you want to test things out, maybe try{' '}
            <EuiLink href="http://next/">
              dropping by the Watercooler AON?
            </EuiLink>
          </p>
        </EuiText>
      </Fragment>
